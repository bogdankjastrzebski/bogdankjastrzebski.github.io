...
To solve for all-pairs shortest paths simultaneously, we define a single, joint linear program. This is a **multi-commodity flow problem,** where each "commodity" is the unit of flow for a specific source-destination pair $(s, t)$.
...
The ultimate power of the techniques comes from a profound source: *the application of geometric and algebraic tools to a fundamentally discrete problem.*
